...
SDL_Color couleurverte={0,128,0};
	...
	reponsef=TTF_RenderText_Blended(policetexte,"Mauvaise Reponse :(",couleurrouge);	
	reponsev=TTF_RenderText_Blended(policetexte,"Bonne Reponse !",couleurverte);
